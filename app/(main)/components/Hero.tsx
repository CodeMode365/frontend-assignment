        ...
        <section className="bg-center bg-no-repeat bg-gray-700 bg-blend-multiply"style={{
            ...
            <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                ...
                <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-rose-700 hover:bg-rose-800 focus:ring-4 focus:ring-rose-300 ">
                        Get started
